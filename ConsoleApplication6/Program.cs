...
namespace ConsoleApplication6
{
    ...
    public enum TokenType
    {
        ...
        Keyword_return, Keyword_def, LeftBrace, RightBrace, Semicolon, Colon, Comma, Identifier, Integer, String, None
    }
        ...
        public List<Token> scan()
        {
            ...
            while (CurrentCharacter != "")
            {
                ...
                if (match("'", null, TokenType.Integer, discard: true))
                {
                    ...
                    tokens.Add(new ConsoleApplication6.Token() { Type = TokenType.Integer, Value = value.ToString(), Line = _line, Position = position - 1 });
                }
                ...
                match(":", null, TokenType.Colon, exact: true);

            }

            // end of file token
            tokens.Add(new ConsoleApplication6.Token() { Type = TokenType.End_of_input, Line = _line, Position = _position });
    ...
    { 
        static void Main(string[] args)
        {
            ...
            //if (args.Length > 0)
            //{
            string path = @"E:\My projects\ConsoleApplication6\ConsoleApplication6\bin\test.txt";
                try
                {
